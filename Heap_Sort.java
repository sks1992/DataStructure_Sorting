...
*  in its two children nodes. The former is called as max heap and the latter
...
*  as an array and the array-based representation is space-efficient. If the
*  parent node is stored at index I, the left child can be calculated by
